...
var main = (function () {
    ...
    Terminal.prototype.exec = function () {
        ...
        this.output.innerHTML += "<span style='font-weight: bold; text-shadow: 0 0 2.5px gray;' class=\"prompt-color\">" + this.completePrompt + "</span> " + command + "<br/>";
    };
    ...
    Terminal.prototype.handleCmd = function () {
        ...
        switch (cmdComponents[0]) {
            ...
            case cmds.HELP.value:
                this.help();
                break;
            case cmds.YOUTUBE.value:
                this.youtube();
                break;
            case cmds.SOUNDCLOUD.value:
                this.soundcloud();
                break;
    ...
    /*Terminal.prototype.balls = function () {
        var link = document.createElement('a');
        link.href = 'https://www.google.com';
        link.target = '_blank';
        link.innerHTML = 'Click here for Google';
        this.type(link.outerHTML, this.unlock.bind(this));
    };*/
    ...
    Terminal.prototype.soundcloud = function () {
        var result = "Soundcloud has been opened!"
        var link = "https://soundcloud.com/v_i_x"
        window.open(link);
        this.type(result, this.unlock.bind(this));
    };

    Terminal.prototype.steam = function () {
        var result = "Steam has been opened!"
        var link = "https://steamcommunity.com/id/V_i_X/"
        window.open(link);
        this.type(result, this.unlock.bind(this));
    };
